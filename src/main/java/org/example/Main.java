...
//                session.persist(owner3);
                ...
                List<Owner> ownerList = session.createNativeQuery("select * from owners", Owner.class).list();

//                for (Owner owner : ownerList){
//                    for (Car car : owner.getCars()){
//                        System.out.println(owner.getName() + ": " + car.getModel());
//                    }
//                }
                ...
                ownerList
                        ...
                        .flatMap(owner -> owner.getCars().stream()
                              .map(car -> owner.getName() + ": " + car.getModel()))
